...
const event2: TransformationEvent = {
  //Fraccionado
  eventId: "event2",
  ...
  outputEPCList: [
    //Las trazas de cualquiera de estos deben ser iguales
...
const event4: TransformationEvent = {
  //Homogeneizado
  eventId: "event4",
  kind: "TransformationEvent",
...
const event7: TransformationEvent = {
  //Extraccion
  eventId: "eventE1",
  kind: "TransformationEvent",
...
const event8: TransformationEvent = {
  //Homogeneizado
  eventId: "event8",
  kind: "TransformationEvent",
  eventTime: "20/12/2019 11:05:12",
...
const event9: TransformationEvent = {
  //Fraccionado
  eventId: "event9",
  kind: "TransformationEvent",
  eventTime: new Date().toISOString(),
...
const event11: TransformationEvent = {
  //Extraccion
  eventId: "event11",
  kind: "TransformationEvent",
  eventTime: "14/12/2019 10:05:12",
...
const event12: TransformationEvent = {
  //Homogeneizado
  eventId: "eventH1",
  kind: "TransformationEvent",
  eventTime: "20/12/2019 11:05:12",
  recordTime: new Date().toISOString(),
  eventTimeZoneOffset: "-3:00",
  inputEPCList: ["T3", "T5", "T6"],
  outputEPCList: ["T4"],
};

const event13: TransformationEvent = {
  //Fraccionado
  eventId: "event13",
  kind: "TransformationEvent",
  eventTime: new Date().toISOString(),
...
const event16: ObjectEvent = {
  ...
  bizStep: "urn:epcglobal:cbv:bizstep:receiving",
  disposition: "urn:epcglobal:cbv:disp:active",
  bizTransactionList: ["RIMP-0000-00000007"],
};
...
const event18: ObjectEvent = {
  ...
  bizStep: "urn:epcglobal:cbv:bizstep:receiving",
  disposition: "urn:epcglobal:cbv:disp:active",
  bizTransactionList: ["RIMP-0000-00000008"],
};
const event19: TransformationEvent = {
  //Extraccion
  eventId: "eventE2",
  kind: "TransformationEvent",
...
const event20: TransformationEvent = {
  //Homogeneizado
  eventId: "eventH1",
  kind: "TransformationEvent",
  eventTime: "20/12/2019 11:05:12",
  recordTime: new Date().toISOString(),
  eventTimeZoneOffset: "-3:00",
  inputEPCList: ["T7", "T8", "T10", "T11"],
  outputEPCList: ["T9"],
};

const event21: TransformationEvent = {
  //Fraccionado
  eventId: "eventF1",
  kind: "TransformationEvent",
  eventTime: new Date().toISOString(),
